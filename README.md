...
2.) Once you have created your virtual machine, you will want to connect to it by using the public IP address the virtual machine is setup with. You will connect using the remote desktop connection app. 
</p>
<br />
